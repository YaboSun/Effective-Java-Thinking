...
public class FactoryMethodPatternTest {
    ...
    public void createOperation() throws Exception {
        ...
        FactoryMethodPattern addFactory = (FactoryMethodPattern) Class
                .forName("factory.pattern.factory.method.AddFactory")
                .newInstance();
        FactoryMethodPattern subFactory = (FactoryMethodPattern) Class
                .forName("factory.pattern.factory.method.SubFactory")
                .newInstance();
        FactoryMethodPattern mulFactory = (FactoryMethodPattern) Class
                .forName("factory.pattern.factory.method.MulFactory")
                .newInstance();
        FactoryMethodPattern divFactory = (FactoryMethodPattern) Class
                .forName("factory.pattern.factory.method.DivFactory")
                .newInstance();
